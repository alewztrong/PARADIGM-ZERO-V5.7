...
"""
███████████████████████████████████████████████████████████████████████████████
  PARADIGMA ZERO — SIM-3D-ULTRAFINA v1.0
  
  FOCO: Região ALTA ao redor de R-2313 (r_min = 72.2 R⊕)
  
  Melhor candidato encontrado:
    a = 1.74, e = 0.57, inc = 3°, Ω = 0°, M0 = 105°
...
# ══════════════════════════════════════════════════════════════════════════════
#  GRADE ULTRA-FINA — REGIÃO ALTA (ao redor de R-2313)
# ══════════════════════════════════════════════════════════════════════════════
...
CONFIG = {
    ...
    # Centrado em: a=1.74, e=0.57, inc=3°, Ω=0°, M0=105°
    'grade': {
        'a_lua': [1.73, 1.735, 1.74, 1.745, 1.75],
        'e_lua': [0.56, 0.565, 0.57, 0.575, 0.58],
        'inc_lua': [2, 2.5, 3, 3.5, 4],
        'omega_lua': [350, 355, 0, 5, 10],  # Ao redor de 0°
        'm0_lua': [95, 100, 105, 110, 115],
    },
...
def analisar_resultados(capturas, arquivo_log):
    log("", arquivo_log)
    log("█" * 70, arquivo_log)
    log("  ANÁLISE FINAL — SIM-3D-ULTRAFINA (REGIÃO ALTA)", arquivo_log)
    log("█" * 70, arquivo_log)
    
    if not capturas:
        log("", arquivo_log)
        log("  Nenhuma captura (r < 70 R⊕) encontrada.", arquivo_log)
        log("  Verificar região complementar (BAIXA).", arquivo_log)
        return
...
def main():
    ...
    arquivo_log = os.path.join(OUTPUT_DIR, f'ultrafina_log_{timestamp}.txt')
    
    print("")
    print("█" * 75)
    print("█" + " " * 73 + "█")
    print("█  PARADIGMA ZERO — SIM-3D-ULTRAFINA v1.0" + " " * 31 + "█")
    print("█  Região ALTA | Centro: a=1.74, e=0.57, inc=3°" + " " * 24 + "█")
    print("█  APENAS 2.2 R⊕ DO LIMIAR DE CAPTURA!" + " " * 35 + "█")
    print("█" + " " * 73 + "█")
    print("█" * 75)
    print("")
    ...
    print("")
    print("█" * 75)
    print("█  SIM-3D-ULTRAFINA COMPLETA" + " " * 46 + "█")
    print("█" * 75)
